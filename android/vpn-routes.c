...
static inline void route_entry(struct rtentry *entry, struct in_addr* dest, struct in_addr* mask, struct in_addr* gateway)
{
...
static int parse_route_entries(char* routes, struct in_addr* gateway, struct rtentry* entries)
{
...
int create_route_entries(char* routes, struct in_addr* ppp_gateway, struct in_addr* default_gateway, struct rtentry** route_entries, int* ppp_routes_count, int* exclude_routes_count)
{
    ...
    *exclude_routes_count = parse_route_entries(exclude_routes, default_gateway, *route_entries + *ppp_routes_count);
